...
class Name:
    @typing.overload
    def __init__(self, attributes: Iterable[NameAttribute[str | bytes]]) -> None: ...
    ...
    def __init__(
        self,
        attributes: Iterable[NameAttribute[str | bytes] | RelativeDistinguishedName],
    ) -> None:
        attributes = list(attributes)
        if all(isinstance(x, NameAttribute) for x in attributes):
            ...
            self._attributes = typing.cast(list[RelativeDistinguishedName], attributes)
        else:
            raise TypeError(
